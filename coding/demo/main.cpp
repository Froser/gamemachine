...
void init()
{
...

	{
		...
		Material m[6] = {
			{ { .5f, .5f, .25f },{ .66f, .25f, .4f },{ .3f, .8f, .76f }, { .2f, .2f, .2f }, 1, { texture, TextureTypeAmbient} },
			{ { .2f, .3f, .7f },{ .4f, .1f, .8f },{ .7f, .5f, .3f },{ .2f, .2f, .2f },  1,{ texture, TextureTypeAmbient } },
			{ { .5f, .5f, .25f },{ .66f, .25f, .4f },{ .3f, .8f, .76f },{ .2f, .2f, .2f },  1,{ texture, TextureTypeAmbient } },
			{ { 1, 0, 0 },{ 0, 1, 0 },{ 0, 0, 1 },{ .2f, .2f, .2f },  1,{ texture, TextureTypeAmbient } },
			{ { .5f, .5f, .25f },{ .66f, .25f, .4f },{ .3f, .8f, .76f },{ .2f, .2f, .2f },  1,{ texture, TextureTypeAmbient } },
			{ { .5f, .5f, .25f },{ .66f, .25f, .4f },{ .3f, .8f, .76f },{ .2f, .2f, .2f },  1,{ texture, TextureTypeAmbient } },
		};
