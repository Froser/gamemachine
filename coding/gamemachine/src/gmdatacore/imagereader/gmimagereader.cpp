...
bool GMImageReader::load(const GMbyte* data, GMuint size, OUT Image** image)
{
	return load(data, size, ImageType_AUTO, image);
}

bool GMImageReader::load(const GMbyte* data, GMuint size, ImageType type, OUT Image** image)
{
