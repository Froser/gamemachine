...
static inline void *gmAlignedAllocDefault(size_t size, int alignment)
{
	void *ret;
	char *real;
...
void* AlignedMemoryAlloc::gmAlignedAllocInternal(size_t size, int alignment)
{
	gm_g_numAlignedAllocs++;
	void* ptr;
