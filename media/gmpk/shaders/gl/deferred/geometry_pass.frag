...
{
	${deferred_geometry_pass_gPosition_Refractivity}.rgb = (GM_model_matrix * _deferred_geometry_pass_position_world).rgb;
	...
	${deferred_geometry_pass_gKs_Shininess} = vec4(GM_material.ks, GM_material.shininess);
